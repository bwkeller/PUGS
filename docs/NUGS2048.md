...
The PUGS halo catalog is built on the AHF (Amiga Halo Finder) output,
...
| $R_{500c}$, $M_{500c}$ | $500\,\rho_\mathrm{crit}$ | Bisection on the enclosed density (`pugs.halo_properties`) |
